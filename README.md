...
-32000|Security error| In case of a `SecurityException` thrown by action `execute(..)`
-32001|Application error|Error contemplated by the application logic. In case of a checked exception thrown by action `execute(..)`
